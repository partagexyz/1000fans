...
if __name__ == "__main__":
    # Upload Music files
    upload_directory(AWS_S3_BUCKET_NAME, '../public/music', 'music/')

    # Upload Video files
    upload_directory(AWS_S3_BUCKET_NAME, '../public/videos', 'videos/')

    # Upload metadata files
    upload_metadata_files(AWS_S3_BUCKET_NAME, '../public')